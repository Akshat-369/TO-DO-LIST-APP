...
public class CommonConstants {
    //frame config
    public static final Dimension GUI_SIZE = new Dimension(540,640);
    ...
    public static final Dimension TASKFIELD_SIZE = new Dimension((int)(TASKPANEL_SIZE.width * 0.88),50);
